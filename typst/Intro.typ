...
- 08/26: Creo capítulo de Depresión en Trastorno Bipolar. Pautas CANMAT
...
#figure([#image("cc.png")], caption: [cc])
...
- Un tratado de psiquiatría (quizás sea más práctico en forma de compendio). Uno de los más usados en este texto es el compendio de Kaplan & Sadock #footnote[Kaplan, H., Sadock, B. J., & Grebb, J. A. (1999). Sinopsis de psiquiatría (pp. 362-98). Medica.].
...
- Un manual de clasificación de enfermedades mentales. Si bien entre los docentes es popular el DSM-IV #footnote[American Psychiatric Association. (1998). DSM IV: manual diagnóstico y estadístico de los trastornos mentales.], hay que recordar que todos los documentos vinculados a salud se guían por la guía de la OMS: CIE-10 #footnote[Guía de Bolsillo de la Clasificación CIE-10: Clasificación de los Trastornos Mentales y del Comportamiento. Ed. Médica Panamericana, 2000.]. El DSM-5 #footnote[American Psychiatric Association. (2014). DSM-5: Manual diagnóstico y estadístico de los trastornos mentales.] puede no ser popular entre algunos docentes (por buenos motivos).
