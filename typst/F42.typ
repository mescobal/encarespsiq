...
#note[Personalidad Anancástica de Kahn (rasgos anales): dado por la tríada:
...
- Neurosis fóbica (si hay fobias límite): serían temores concretos con conductas acordes al temor, circunscriptas, con crisis de angustia, con conductas de evitación eficaces. En cambio las obsesiones fóbicas son temores mágicos con rituales independientes del temor, sin crisis de angustia, con ineficacia de la conducta de evitación. Los mecanismos de defensa implicados son distintos.
- Neurosis de angustia: si bien está de fondo, la ansiedad se ha visto canalizada por la instalación de mecanismos defensivos específicos. La ansiedad-angustia aparece como elemento de descompensación, centrando el cuadro en los mecanismos obsesivo-compulsivos que se ven exacerbados y sobrepasados.
- Causa orgánica de la crisis de ansiedad-angustia: Ver neurosis de angustia.
- Causas orgánicas del TOC: Tumores cerebrales.
- Trastorno de personalidad obsesivo-compulsivo: Queda descartado porque el paciente es consciente de sus síntomas, son egodistónicos y éstos se dan fundamentalmente en el contexto intrapsíquico y no interpersonal.
- Depresión mayor con rumiación obsesiva \(depresión anancástica): si bien está presente la depresión pensamos que ésta es secundaria al trastorno neurótico analizado. En el trastorno afectivo no existen rituales, las ideas obsesivas no se sienten como intrusas ni extrañas y están centradas en temas vinculados a la depresión.
- Inicio seudoneurótico de una esquizofrenia: En la esquizofrenia las obsesiones son más extravagantes, menos precisas, con menor carga afectiva, vividas con cierta indiferencia, sin conciencia de enfermedad \(las acepta pasivamente). En este caso existiría un SDD. En las auténticas obsesiones falta la convicción e identificación morbosa con la idea que caracteriza al delirio.
...
- Rituales ligados a otras patologías (Trastornos de la Conducta Alimentaria).
...
====== Biológico
- Genético: más concordancia en gemelos idénticos.
- Neurofisiológico y neuroquímico: alteraciones en el mecanismo de inhibición frontal. Alteraciones neuroquímicas: en los sistemas serotoninérgico y dopaminérgico en los ganglios basales \(núcleo caudado y putamen) durante el desarrollo que alteran el funcionamiento de dichos NT, lo que explicaría la acción de los ISRS. Esto está basado en la aparición de sintomatología OC en pacientes sometidos a la acción de m-CPP \(agonista serotoninérgico), síntomas que se inhiben con metergolina \(antagonista serotoninérgico no selectivo).
- Neuroanatómico: alteraciones neuroanatómicas: basado en la asociación entre sintomatología OC y varios síndromes neuropsiquiátricos o neurológicos y en la eficacia de la neurocirugía \(Cingulotomía) para reducir los síntomas \(resección de tractos que van desde el Cíngulo al Estriado).
  - Estudios de neuroimagen: involucran de forma consistente 3 sitios de hiperactividad que se normalizan luego de un tratamiento medicamentoso o psicoterapéutico efectivo:
    - Región orbital y medial de la Corteza Frontal.
    - Núcleo Caudado \(cabeza)
    - Corteza del Cíngulo
- Neuropsicológico: se plantea la existencia de alteraciones en el proceso de la información, involucrando en el TOC factores tales como:
...
- Formación reactiva: pautas de comportamiento, sentimientos o deseos, diametralmente opuestos a los deseos reprimidos. Contribuye a la formación de rasgos de carácter. La sintomatología puede expresar tanto un deseo como medidas protectoras contra éstos.

En un intento por hacer un enfoque más comprensivo de este paciente podemos vincular desde el punto de vista psicológico el surgimiento de sus síntomas \(independientemente del modelo teórico que usemos para explicarlos) con:
- Agresividad latente
...
- Opciones con evidencia de ineficacia: ECT.

El tratamiento que muestre eficacia será mantenido por un tiempo prolongado a dosis elevadas ya que la suspensión índice de recaídas.
...
- Fobia de impulsión homicida \(por lo general a un ser querido). Se vincula con la fobia a los cuchillos, armas u objetos cortantes, evitándolos por el miedo excesivo que se siente de pasar al acto.
- Obsesiones fóbicas Eritrofobia: temor a ruborizarse en público. Por lo general se vincula más a la vergüenza de que una falta \(generalmente de tipo sexual) se le lea en la cara. Nosofobia: temor a una enfermedad, a contaminarse por un virus, microbios o suciedad. Temor obsesivo a ser dañado por un agente exterior \(genera rituales de limpieza). Es un temor obsesivo hipocondríaco. Tanatofobia: temor a la propia muerte o a la de un ser querido. Dismorfofobia: idea obsesiva de que una parte del cuerpo es deforme o desagradable.

#tip[Recomiendo leer: The Journal of Clinical Psychiatry, Vol 63, Supp. 6 \(2002), con una revisión sobre TOC, trastornos TOC símiles, TOC en la infancia y TOC refractario. Algunos datos del encare están sacados de revisiones de esa revista.]
