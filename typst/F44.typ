...
Puede haber una depresión atípica (irritabilidad, hipersomnia, hiperorexia).
...
- Indiferencia hacia el síntoma ("bella indiferencia")
...
#fa-icon("lightbulb"): El TP Histriónico se asocia a: Trastorno de Somatización, Trastorno Conversivo/Disociativo, otros trastornos del grupo B.
...
#fa-lightbulb() : En el DSM el eje I y el II son independientes (hasta cierto punto), por lo cual se puede diagnosticar (en teoría) un trastorno conversivo con o sin un trastorno de la personalidad comórbido.

#fa-triangle-exclamation() : Desde el punto de vista de la nosografía clásica no se puede diagnosticar una neurosis histérica y un trastorno de la personalidad histriónico.
...
- Trastorno de Identidad Disociativo:
  ...
  #fa-lightbulb() : el encare de un trastorno somatomorfo puede tener algunos puntos en común con el encare de una neurosis histérica, pero con la nosografía moderna quedan en categorías distintas.
...
#fa-triangle-exclamation(): no es diferencial para la nosografía DSM. La nosografía clásica exige personalidad + síntomas, pero la personalidad es de tipo neurótico (egodistónico, autoplástico) y el TdelaP no (egosintónico, aloplástico).
...
Se postula la existencia de alteraciones en comunicación interhemisférica, hipometabolismo del hemisferio dominante, hipermetabolismo del no dominante. Alteración de comunicación con la sustancia reticular.
...
- TAC de cráneo: valorando repercusión de múltiples caídas.
- Valoración general: hemograma, glicemia, azoemia, creatininemia, orina completa, ionograma., funcional
y enzimograma hepático.
...
Durante la internación: psicoterapia de apoyo buscando crear un vínculo terapéutico que asegure el apego al tratamiento a largo plazo y creando un espacio de abordaje maduro de sus conflictos.

Psicoeducación.

Alta: se efectuará lo antes posible. Controles quincenales que iremos espaciando. Evitar polifarmacia. Re-evaluar la necesidad de medicación en forma periódica.
