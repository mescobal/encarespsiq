...
_Episodio Hipomaníaco_

Requiere: A y B: igual que manía, pero duración de al menos 4 días
...
_Episodio Depresivo_

Ver encares de depresión

====== Diagnóstico nosológico

_Trastorno Bipolar I_
...
_Especificadores del trastorno_

Curso:
- ciclos rápidos \(al menos 4 episodios en 12 meses
...
===== Del trastorno
<_del_trastorno>
+ Con psicosis crónicas: en el joven se pueden ver debut clínico de Esquizofrenia o de un Trastorno Esquizoafectivo con un episodio maníaco. A favor: deterioro en el curso evolutivo, el hipopragmatismo o el corte existencial, el
delirio incongruente con el estado de ánimo. En contra: prima la alteración del humor por sobre la del pensamiento, no elementos del Síndrome Disociativo-Discordante, por los AF y los AP.
+ Demencias: en el paciente añoso se puede ver el debut clínico de un cuadro Demencial, alejándonos los AF y AP, la ausencia de causa orgánica y la falta de un deterioro global cognitivo.
+ Trastorno de la personalidad: Tanto DD como comorbilidad.
...
==== Paraclínica
<_paraclínica_9>
El diagnóstico es clínico. La paraclínica está destinada a realizar una valoración general del paciente, descartar diagnósticos diferenciales y con miras a los diferentes recursos terapéuticos de los que disponemos.
Lo solicitaremos desde un punto de vista integral: biológico, psicológico y social.
...
#note[Contraindicaciones de ECT: 
- IAM reciente
...
- Primera línea en monoterapia: litio, quetiapina, divalproato, asenapina, paliperidona, risperidona, cariprazina.
- Primera línea en combinación: quetiapina + litio/divalproato, risperidona + litio/divalproato, aripiprazol + litio/divalproato, asenapina + litio/divalproato.
- Segunda línea: olanzapina, carbamazepina, olanzapina \ litio/divalproato, litio + divalproato, ziprasidona, haloperidol, ECT.
...
- Hipomanía: mismo esquema que manía eufórica \(con menos énfasis en el uso de antipsicóticos).
- Manía con síntomas psicóticos: Divalproato \(o Litio) + AAP \(o CAP) cambiar AAP o + BZD DVP + LI cambiar AAP o AAP + CAP ECT DVP + LI + CBZ \(o agregar Clozapina)
- Manía en paciente con ciclado rápido: DVP DVP + \(LI o CBZ) + AAP DVP \ LI + CBZ Clozapina Lamotrigina Gabapentina ECT
- Depresión en bipolar \(no psicótica - no ciclos rápidos) sin medicación previa moderado: Li +AD
- Depresión en bipolar \(no psicótica - no ciclos rápidos) sin medicación previa severo: LI \(o DVP) + AD LI + DVP.
- Si estaba con estabilizador: maximizar estabilizador como primer paso Li + DVP + AD o Lamotrigina + AD si no tenía \(o cambiarlo).
- Si hay refractariedad en la depresión: ECT T3 Otros estabilizadores Clozapina o estimulante o fototerapia.
- Episodio depresivo psicótico: igual pauta, con más énfasis en antipsicóticos atípicos \(ECT a cualquier altura del algoritmo).  
- Episodio depresivo psicótico: igual pauta, con más énfasis en antipsicóticos atípicos \(ECT a cualquier altura del algoritmo).    
- Depresión en paciente con ciclado rápido: DVP + \(Li o CBZ o Lamotrigina) + AD cambio de AD T3/T4 o AAP Gabapentina o Clozapina o Fototerapia → ECT.

#note[Regla general: LIT en manía típica, DVL en el resto \(por se de más fácil manejo).]
...
- Primera línea. Nivel 1: Quetiapina, Litio, Lamotrigina. Nivel 3: Lurasidona + Litio/Divalproato. Nivel 4: Lurasidona, Lamotrigina adjunto.
...
En la fase de mantenimiento, es de primera línea la psicoeducación. De segunda línea: psicoterapia cognitivo-comportamental, terapia enfocada en la familia, terapia de ritmo social e interpersonal y soporte entre pares.
...
==== En suma
<_en_suma_4>
Hemos visto un paciente de sexo , de años de edad, con un MSEC , con AF de #fa-icon("paperclip"), con AP de #fa-icon("paperclip"), que consulta por síntomas #fa-icon("paperclip"), en quien diagnosticamos un Trastorno Bipolar de tipo I / II, de características #fa-icon("paperclip"). con un episodio actual #fa-icon("paperclip"), con características #fa-icon("paperclip"), en comorbilidad con #fa-icon("paperclip"). Hemos planteado diagnósticos diferenciales con #fa-icon("paperclip"), hemos estudiado con #fa-icon("paperclip"), y hemos tratado con #fa-icon("paperclip"). Planteamos una evolución buena con el tratamiento indicado, dependiendo el pronóstico a largo plazo de la adherencia al tratamiento.
