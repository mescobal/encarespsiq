...
=== Notas clínicas
Un EPA no es un diagnóstico nosológico sino un cuadro clínico que determina un encare "de planteo". En caso de estar frente a un EPA polimorfo, se puede hacer el encare de PDA.

Puede tener múltiples nombres (no siempre son sinónimos): Psicosis Delirante Aguda, Trastorno Psicótico Breve, Psicosis Reactiva Breve, Boufée Delirante, Psicosis Alucinatoria o Imaginativa Aguda, deliro d’emblée \(de inicio súbito). En la CIE: Trastornos Psicóticos Agudos y Transitorios (F23).

=== Encare

==== En suma

Paciente con AFP de #fa-icon("paperclip"), APM de #fa-icon("paperclip"), APP de #fa-icon("paperclip") que es traido por un cuadro clínico de inicio agudo, polimorfo, centrado en una alteración del pensamiento, en un contexto de (pupererio, bajo nivel intelectual, retardo mental, trastorno de la personalidad, UISP, etc.)
...
Curso de vida. Sº de consumo de sustancias.
...
Personalidad Destacar todo lo que haya en la HC porque importa en el DD y en el pronóstico.
...
- Causa orgánica o medicamentosa: descartaremos por la clínica y paraclínica, no existiendo datos en la historia (tiene más peso en un \> 40 años, sin AF ni AP psiquiátricos).
  ...
  - Neurológica: tumores, TEC, hematoma subdural, epilepsia \(crisis parciales complejas), esclerosis múltiple, corea \(Huntington), vascular.
  - Demencias \(Alzheimer, Pick). Ictus.
...
#tip[Orientadores de organicidad:
- primer episodio con debut tardío
- atipicidad
- alucinaciones olfativas o visuales prominentes
- evolución atípica.]
...
===== Biológico
<_biológico_7>
Haloperidol, NL incisivo, con efecto antidelirante, del grupo de las Butirofenonas, 5 mg i/m H8 y H20, que regularemos según respuesta clínica y tolerancia \(pudiendo agregar otros 5 mg H14 i/m de ser necesario). Controlaremos la aparición de efectos secundarios tipo extrapiramidales \(temblor, rigidez, rueda dentada, bradipsiquia). Si aparecen concentraremos las dosis en la noche \(ya que éstos no aparecen durante el sueño). Actúa bloqueando los receptores dopaminérgicos D2 cortico-meso-límbicos.

Deben vigilarse efectos extrapiramidales \(en especial distonías agudas) en pacientes varones, jóvenes. En caso se puede plantear asociar antiparkinsonianos de entrada. Similares consideraciones en caso de AF de enfermedad de Parkinson o de AP de reacciones extrapiramidales.
...
Lorazepam 1 amp i/m cada 6-8 horas, pasando luego a vía oral.

Segunda línea: Levomepromazina \(NL sedativo) 25 mg i/m cada 8 horas. En este caso estaremos atentos a los efectos secundarios: sedación, hipotensión postural, efectos anticolinérgicos).
...
PVI: sujeto a riesgos vitales que impliquen sus conductas delirantes. Posibilidad de instalación de depresión postpsicótica. PPI y PPA: puede ser variable.
...
- hormonal
- factores psicosociales: estrés, cambios vitales por embrazo \(matrimonio, roles). Psicoanálisis: pérdida narcisita del yo independiente.

Predisponentes:En las primíparas y pacientes con AP o AF de trastornos del estado de ánimo o episodios previos de depresión o psicosis postparto, se incrementa el riesgo. Recurrencia elevada: psicosis 1/3, depresión 1/2.

==== En suma
Hemos visto un paciente de sexo #fa-icon("paperclip"), de #fa-icon("paperclip") años, procedente de #fa-icon("paperclip"), con AF de #fa-icon("paperclip"), APM de #fa-icon("paperclip"), APP de #fa-icon("paperclip"), que consulta por #fa-icon("paperclip"), en quien diagnosticamos #fa-icon("paperclip"), reconociendo como desencadenantes #fa-icon("paperclip"), planteando diagnósticos diferenciales con #fa-icon("paperclip"), que hemos estudiado con #fa-icon("paperclip"), realizado un tratamiento con #fa-icon("paperclip"), planteando un pronóstico #fa-icon("paperclip").
