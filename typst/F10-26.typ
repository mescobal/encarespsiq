...
A esto se le agrega neuropatía periférica y signos oftalmológicos #footnote[Caine D, Halliday GM, Kril JJ, Harper CG (1997) Operational criteria for the classification of chronic alcoholics: Identification of Wernicke’s encephalopathy. J Neurol Neurosurg Psychiatry. 62:51–60.].

Sin embargo la ataxia ocurre solo en 23
...
- Lesiones cerebrales localizadas secundaria a complicaciones del alcoholismo (traumatismos, infección, cáncer, patología vascular) - Deficiencias nutricionales (especialmente otras formas de vitamina B, C o deficiencia proteica \[pelagra, escorbuto\])
...
- abstinencia alcohólica severa (como el DT) - sepsis, neumonia, infecciones urinarias #footnote[Wijnia JW, Oudman E, van Gool WA, Wierdsma AI, Bresser EL, Bakker J, van de Wiel A, Mulder CL (2016) Severe infections are common in thiamine deficiency and may be related to cognitive outcomes: A cohort study of 68 patients with Wernicke-Korsakoff syndrome. Psychosomatics. 57:624–633.]
...
Por lo tanto antes de planear el tratamiento debe evaluarse qué estructuras están afectadas y cuáles están intactas. Esto puede incluir interconsultas con neurólogo, estudios de imagen y test neuropsicológico #footnote[Van Dam MJ, Van Meijel B, Postma A, Oudman E (2020) Health problems and care needs in patients with Korsakoff’s syndrome: A systematic review. J Psychiatr Ment Health Nurs. 27:460–481.]. Puede requerirse el tratamiento de síntomas asociados (comportamientos adictivos). Si hay una lesión de ganglios basales, puede plantearse el uso de antiparkinsonianos.
