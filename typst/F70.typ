...
+ Según HC puede plantearse DD con: Neurosis, Trastorno de la Personalidad. Neurosis: necesita una personalidad más conformada (el oligofrénico puede usar mecanismos de defensa seudoneuróticos).
...
- Test de personalidad proyectivos y no proyectivos.
...
+ Realizaremos Flunitrazepam 2 mg v/o ya que consideramos fundamental la regulación del sueño. Retiraremos al obtener mejoría.

#note[Considerar el uso de antipsicóticos atípicos, sobre todo Risperidona.]
...
Estará destinado a incidir sobre la adaptación social, procurando la autonomía, sobre todo con medidas psicosociales.
...
Vincularemos a taller de rehabilitación que puede ser dificultoso por los trastornos conductuales. Realizaremos psicoeducación de familiares para mejorar continencia del medio, lograr controles clínicos periódicos y cumplimiento de la medicación. Vincularemos a la familia con experto en terapia familiar para cambio de conductas de ésta que puedan incidir en las descompensaciones. Eventualmente vincularemos al paciente con expertos en Retraso Mental. Vincularemos con AS para que tenga acceso a beneficios sociales.

==== Evolución y pronóstico

- PPI: bueno con tratamiento instituido, supeditado a trastornos conductuales con auto/hetero.
...
- PVA: sujeto a lo orgánico que tenga, en cierto modo vinculado al PPA que pensamos reservado ya que está dificultado por:
  ...
  - Bajo umbral de reactividad para psicosis Evolución que intentamos mitigar con las medidas efectuadas.
