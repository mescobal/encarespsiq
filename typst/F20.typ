...
- Con otros delirios crónicos:
  ...
  - Psicosis Infantil: que descartamos porque no existe una evolución deficitaria con retirada a un mundo autista como en nuestro paciente.
...
- Efectos secundarios por acción sobre receptores muscarínicos, adrenérgicos, anti H1:
  ...
  - taquicardia
  - leucocitosis
- luego de beneficio terap máx se puede pasar a mantenimiento titulando hacia abajo hasta un rango de 150- 300 / día 
...
- ideal descenso lento c/ wash out de 24 hs y titulación lenta de Clozapina / si hay graves elementos de descompensac se pueden  superponer / post depot espe-rar 4-6 sem / adición de otro NL \> riesgo de ef 2º EP
...
===== A largo plazo
- medicación efectiva
- entrenamiento socializante \(rehabilitación / psicoeducación)
...
Catatónico: según el síndrome catatónico. Cuadro de inercia sobre el que sobrevienen bruscos brotes de impulsividad. Estuporosa \(reacciones violentas), agitada \(violencia extrema), catatonismo \(discordancia PM).

Paranoide: adulto joven, cuadro centrado en el delirio paranoide, aunque existen elementos DD, pese al tipo de evolución no existe deterioro marcado.
...
- A. 2 síntomas de 5 \(delirio, alucinaciones, lenguaje desorganizado, comportamientos desorganizados o catatónicos, síntomas negativos \[aplanamiento afectivo, alogia, abulia\]). \(1 síntoma solo si las ideas delirantes son extrañas). O AAV y SAM.
...
T Esquizoafectivo :si hay síntomas afectivos en algún momento de la evolución. \(Y con TEA en el caso de diagnóstico de T Esquizoafectivo).

Con otros delirio crónicos:

- Paranoia: que descartamos ya que la paranoia presenta un delirio sistematizado, expresado con calor afectivo, de estructura paranoica y en la cual no existe una evolución deficitaria con retirada a un mundo autista como en nuestro paciente.
- Parafrenia: que descartamos porque la Parafrenia se caracteriza por un pensamiento paralógico, fantástico, a mecanismo imaginativo, pero s/t por el mantenimiento de los pragmatismos, sin deterioro, con la característica bipolaridad con la que coexisten el polo delirante y el polo adaptado a la realidad \(edad 30-35 años).
- Esquizofrenia: que descartamos porque la Esquizofrenia se caracteriza por un curso progresivo deteriorante, con deterioro psicointelectual y social, con la característica bipolaridad con la que coexisten el polo delirante y el polo adaptado a la realidad \(edad 30-35 años).
