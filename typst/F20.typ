...
===== Catatónico
Por lo gral inicio por EPM / pasaje de estupor a estados catalépticos / también puede empezar por un síndrome paranoide / raro curso crónico, por lo general periódico.
...
- (a) sd tipo I : "esquizofrenia aguda" : síntomas positivos / alt en transmisión dopaminérgica / potencialmente reversibles / predictores de buena respuesta al tto NL / pueden ser seguidos x el desarrollo de sd tipo II o presentarse combinados
- (b) sd tipo II : "estado defectual" : síntomas negativos / asoc a trast cognitivos y cambios estructurales del cerebro / por lo gral indican irreversibilidad y mala evolución a largo plazo / pobre resp a NL
...
- A mecanismo: intuitivo (se le aparece como verdad revelada), interpretativo (percepciones reales que el paciente interpreta a la luz de sus propias convicciones), alucinatorio \(eco, robo, adivinación, enunciación de
...
- Sensorial: sensaciones parásitas \(alucinaciones psicosensoriales, visuales, cenestésicas, táctiles, gustativas). Fenómenos sensoriales puros, anideicos. Triple automatismo:: motor, ideico e ideoverbal \(elocución, ideación, formulación ideoverbal espontánea, articulación verbal forzada) Desdoblamiento mecánico del pensamiento:: eco del pensamiento, eco de la lectura, comentario de actos. Pueden ser anticipados, simultáneos o retardados con respecto al acto. Pequeño automatismo mental:: emancipación de abstracciones, \"nebulosa anticipada de un pensamiento indiscernible\"
...
Psicosis crónica: #fa-icon("paste")
...
====== Tipo clínico
+ Hebefrénico: Adolescente o adulto joven \(15-25 años), SDD, jovialidad pueril, desorganización conductual, irresponsables, imprevisibles, rápido deterioro, no predomina el delirio \(transitorio y fragmentario).
+ Catatónico: Según el síndrome catatónico. Cuadro de inercia sobre el que sobrevienen bruscos brotes de impulsividad. Estuporosa \(reacciones violentas), agitada \(violencia extrema), catanonismo \(discordancia PM).
+ Paranoide: \> 20 años \(adulto joven), cuadro centrado en el delirio paranoide, aunque existen elementos DD, pese al tipo de evolución no existe deterioro marcado.
+ Simple: Pérdida insidiosa del interés o motivación, ambición o iniciativa.
+ Indiferenciado CIE-10, DSM, sin claro predominio de ningún tipo.

Según el caso clasificar con criterios de esquizofr \(+) ó \(-)
Estado Descompensada: por presentar alteración de las conductas basales, empeoramiento en pragmatismos, oscilaciones o alteraciones del humor.
====== Descompensada
...
====== Esquizofrenia
- 2 ó más : delirios / alucinaciones / discurso desorganizado / comportamiento desorganizado o catatónico / sínt negativos \(aplanamiento afectivo / pobreza del discurso / apatía / retraimiento social) . disfunción social / ocupacional 
- \> 6 meses 
- exclusión de : trastorno humor, esquizoafectivo, alt médica, sustancias (posibilidad de plantear dx diferenciales con otros trast de eje I : humor – c/ síntomas psicóticos -, esquizofreniforme, psicótico breve, delirante, esquizoafectivo, trast médico, sust)
...
- menos de 1 año desde el inicio de los síntomas de fase activa
...
- En algún momento: episodio afectivo + criterio A de esquizofrenia
- En el mismo período: 2 semanas de ideas delirantes o alucinaciones en ausencia de síntomas afectivos \(para descartar Episodio Afectivo con síntomas psicóticos).
- Síntomas afectivos durante una parte sustancial del total de la duración \(fases activa y residual) de la enfermedad \(para descartar síntomas afectivos puntuales en una Esquizofrenia).
...
- Con EPA en determinada patología.
  - Con causas orgánicas de delirio
...
Otros:
  - Psicosis Infantil: que descartamos porque no existe una evolución deficitaria con retirada a un mundo autista como en nuestro paciente. Puede plantearse con Psicosis Infantil \(DSM : trast gralizado del desarrollo) si se sospecha inicio muy temprano.
  - RM: como comorbilidad. La esquizofrenia es 3 veces más frecuente que en la población general.
  - Depresión psicótica
  - Trastorno obsesivo-compulsivo (vs máscara obsesiva en una esquizofrenia)
...
Anatómicos: vinculados a formas deficitarias, con anomalías estructurales inespecíficas en la TAC y RNM con de ventrículos laterales / PET y SPECT \( utilización de glucosa por el cerebro y valorac del flujo sanguíneo ) muestran hipoactividad en lóbulo frontal y actividad anormal en varias áreas del cerebro.
...
#note[Según situación clínica valorar inicio c/ APS típicos o atípicos]
...
Agregaremos antiparkinsonianos de síntesis tales como el Biperideno 2 mg v/o H 8:00 y H 14:00. Lo agregaremos de entrada si existen AP de parkinsonismo o efectos secundarios o AF de enfermedad de Parkinson.

_Sedación_

Preferimos las benzodiazepinas
...
Si a los 10-15 días no existe mejoría considerable del cuadro delirante alucinatorio, indicaremos ECT a realizar por psiquiatra y anestesista. Realizaremos una sesión día por medio, con oxigenoterapia, monitoreo ECG
y EEG con barbitúricos de acción corta y curarizantes como la succinilcolina… \(resto del papo).
...
_Trastorno esquizoafectivo_

Pauta similar, agregando las pautas de tratamiento de los Trastornos Afectivos (estabilizadores del humor en el subtipo biploar, antidepresivos en el subtipo depresivo). Antipsicóticos atípicos, preferncialmente.

_Refractariedad_

En caso de tratarse de un paciente que no ha mostrado respuesta a 2 antipsicóticos diferentes usados por tiempo adecuado (6 semanas) a dosis adecuada, puede plantearse el uso de Clozapina. La misma conducta se adoptará en caso de reacciones adversas intratables provocadas por antipsicóticos convencionales.

Su mecanismo de acción tiene la particularidad de presentar menor afinidad por los receptores D2 que los NL típicos. Tiene un bloqueo D1 equivalente a D2, y además bloquea los receptores 5HT2, con mayor especificidad por los D2 del sistema meso-límbico, por lo cual no solo son extremadamente raros los ES extrapiramidales sino que la presencia de éstos con otro antipsicótico puede ser una indicación para el uso de Clozapina (especialmente en el caso de la Disquinesia Tardía). 

El uso de Clozapina requiere de una valoración clínica y paraclínica previa con controles sistemáticos a nivel hematológico por el riesgo de agranulocitosis (2% en el primer año de tratamiento, reversible si se suspende el tratamiento en forma precoz): hemograma semanal por 18 semanas, luego mensual. La agranulocitosis, efecto secundario idiosincrático, en un 75% de los casos aparece entre las semanas 4 y 18. También serán excluidos aquellos pacientes con AP de crisis comiciales por la posibilidad de descenso del umbral convulsivo.

La valoración pretratamiento incluye: anamnesis (AP de agranulitosis por drogas, alteraciones en la médula ósea. AP de convulsiones) y paraclínica: hemograma c/fórmula leucocitaria normal. Se incluye además una evaluación cardiológica.

Debe valorarse previo al inicio la posibilidad de cumplimiento, ya que en caso de abandono mayor a 48 horas, debe comenzarse de nuevo con el esquema inicial.

Contraindicaciones:
- AP de agranulocitosis por drogas
- recuento leucocitario bajo (< 3.500 GB)
- trastornos en la médula ósea
- uso concomitante de otro supresor de la médula ósea (ejemplo: carbamazepina).

Precaución en el uso concomitante con medicamentos que bajen el umbral convulsivo (fenotiazinas).

Posología : inicio por 25 mg / día probar tolerancia \(sedación y P.A.) y aumentos diarios de 25-50 mg hasta 300 / día en 7-14 días. Eficacia antipsicótica entre dosis de 300 y 450 mg/día. Dosis máx recomendada 600 mg, aunque a veces se requieren hasta 900

Efectos secundarios por acción sobre receptores muscarínicos, adrenérgicos, anti H1:
...
Monitoreo:
- monitoreo leucocitario : semanal en 1ª 18 sem / luego mensualmente / 4 sem post depot
...
Antipsicóticos: al principio con igual dosis con la que tuvo mejoría, ya que el ingreso al hogar puede significar un estrés importante. 

Si se trata de un paciente con bajo perfil de cumplimiento, si bien preferimos la medicación v/o que nos permite un mejor manejo de la dosis, indicaremos previo al alta NL de depósito como:
...
Pronóstico psiquiátrico alejado: es una enfermedad crónica con frecuentes recaídas con tendencia al deterioro psicointelectual y social progresivos \(ausencia de iniciativa, aplanamiento de respuestas emocionales, descuido personal y declinación de la competencia laboral).
Intentaremos mitigar esta evolución con las medidas mencionadas. La forma clínica influye en el pronóstico siendo la forma paranoide la de más bajo potencial evolutivo autista \(las hebefrénicas son más rápidas).

En lo vital alejado:

- menor expectativa de vida por mayor morbi-mortalidad que población general \(tabaquismo intenso)
- IAE frecuente en contexto discordante 
- IAE por de frecuencia de depresiones
