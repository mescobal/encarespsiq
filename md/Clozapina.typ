...
* Bloqueo de receptores D2, reduciendo los síntomas positivos en la
psicosis y estabilizando síntomas afectivos. * Bloqueo de receptores
5HT-2A provocando aumento de la liberación de DA en algunas áreas del
cerebro reduciendo efectos motores y probablemente mejorando síntomas
cognitivos y afectivos. * Interacciones en una gran cantidad de
receptores de NT * Interacción con 5HT-2C y 5HT-1A icon:arrow-right[]
puede contribuir a la eficacia para síntomas cognitivos y afectivos en
...
eficacia * En la práctica: 16-20 semanas para completar una prueba
...
Semanas 3-4: 400-500 mg/día y dejar un período de observación antes de
aumentar la dosis.

En caso de abandono > 2 días: retomar a menor dosis.

Discontinuación: reducción gradual en 1-2 semanas. Si está indicada la
discontinuación abrupta, continuar monitorizando efectos secundarios y
síntomas psicóticos. Si se interrumpió el tratamiento por más de 1
semana comenzar con titulación inicial de dosis. Tomar precauciones
extras ya que los efectos adversos pueden intensificarse. Puede haber
psicosis de rebote al retirar rápido. Luego de interrumpir: controles 1
vez x semana x 1 mes.
...
* Inhbidores de 1A2 (Fluvoxamina): bajar dosis de CLZ * Inductores 1A2
(tabaquismo): aumentar dosis de CLZ * Inhibidores 2D6 (Paroxetina,
Fluoxetina, Duloxetina) en general no se necesita ajustar dosis de CLZ.
* Inhibidores 3A4 (Nefazodona, Fluvoxamina, Fluoxetina) en general no se
necesita ajustar dosis de CLZ. * CLZ puede aumentar efecto de
antihipertensivos.

Otros: Alcohol, depresores del SNC, anticolinérgicos. Drogas que
deprimen MO. IMAOs, narcóticos, antihistamínicos, BZD, anticolinérgicos,
antihipertensivos, adrenalina, depresores respiratorios. Warfarina.
Fármacos con alta unión a proteínas, cimetidina, fenitoina, CBZ,
eritromicina, ISRS, litio. No administrar CBZ ni DFH para tratar
convulsiones.
...
tóxica o idiosincrática (excepto granulocitopenia o agranulocitosis por
quimioterapia previa). Alteraciones funcionales de la médula ósea.
Trastornos mieloproliferativos. * Epilepsia no controlada. * Psicosis
alcohólica y otras psicosis tóxicas. Intoxicación por fármacos. *
Condiciones comatosas. Colapso circulatorio. Depresión del SNC. *
Enfermedad renal o cardíaca severa. Enfermedad hepática activa asociada
...
hemograma en el día ** Hemograma diario hasta ≥ 1000/mm3 ** Luego 3
hemogramas por semana ** Luego hemograma semanal por 4 semanas ** Luego
hemograma mensual

Neutropenia severa: < 500/mm3

* Recomendación: ** Consulta con hematólogo ** No retomar a menos que
los beneficios superen los riesgos * Monitoreo ** Repetir hemograma en
el día ** Hemograma diario hasta ≥ 1000/mm3 ** Hemogramas 3 por semana
hasta ≥ 1500/mm3 * * Si se retoma: hemograma semanal como al inicio
...
with potentially life-threatening adverse effects be rechallenged with
clozapine? A systematic review of the published literature.
Schizophrenia research, 134(2-3), 180-186. * Meltzer H. Suicide in
Schizophrenia: Risk factors and clozapine treatment. J Clin Psychiatry
1998:59 (Suppl 1). * Meltzer H. et al. Reduction of suicidallity during
clozapine treatment of neuroleptic resistant Schizophrenia. Am J
Psychiatry 1995:152 183-190 * Stahl, Stephen M. Prescriber’s Guide:
Antidepressants: Stahl’s Essential Psychopharmacology. Cambridge
