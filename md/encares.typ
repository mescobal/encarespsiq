...
Estoy a favor de lo segundo, pero a su vez estoy de acuerdo con que no hay que mezclar. Si planteamos un diagnóstico siguiendo una nosografía, no podemos plantear diagnósticos diferenciales siguiendo otra. El problema es que la alternativa (mantener dos diagnósticos y 2 grupos de
...
- Memoria inmediata sensorial (primaria): está en la mente mientras se usa; si no se codifica en la memoria secundaria se pierde. Exploración: recordar y reproducir lo presentado en 30”. Amplitud de dígitos.
...
+ Leve (1-3 años): disminución moderada de memoria, + eventos recientes, anomia, problemas con concepción de tiempo. Desorientación geográfica.
+ Moderada (2-10 años): disminución severa de memoria, afasia receptiva, desorientación en tiempo y espacio, trastorno de juicio y en capacidad de resolución de problemas.
+ Severa (8-12 años): grave afectación de memoria, juicio y orientación,. Lenguaje incomprensible o mutismo, rigidez de postura y flexibilidad. Incontinencia.
...
Infartos pequeños y efectos acumulativos en progresión geométrica en el tejido cerebral secundario a enfermedad vascular sobre todo hipertensiva.
...
#block[
#strong[Evidencia moderada: \* Dieta mediterránea \* Reducción de
bebidas con]
...
#block[
#strong[Evidencia baja o muy baja \* Entrenamiento cognitivo \* Manejo
de la]
...
#block[
#strong[Evidencia insuficiente \* Uso de antidepresivos para reducir
riesgo de]
...
#block[
#strong[No recomendado \* Vitamina B y E, ácidos grasos
poliinsaturados,]
...
- Síndrome delirante Delirio pobre, ideación paranoide, robo, vinculado
  a trastornos cognitivos. Manifestado en lo conducutal por
  \[desarrollar\].
...
<_síndrome_intelectual_deficitario_adquirido>
...
- fijación: olvido de cosas que le dicen o pensaba hacer \* inmediata:
  repetición de objetos \* evocación: #strong[tardía s/p: hablar de
  gravedad si está alterada] reciente: incapacidad de retener más de un
  minuto el material \(ej: nombre del entrevistador). También muestra la
  incapacidad de fijación. Se aprecian falsos reconocimientos,
  fabulación. Ley de Ribot: solidez de recuerdos antiguos en relación a
  los recientes. Orientación: . 1º alopsíquica \(primero tiempo, luego
  espacio) .
...
transmisión glutamatérgica \(frente a un aumento de radicales libres,
hay mayor acción glutamatérgica). Radicales libres: son especies
oxigenadas altamente reactivas que contribuyen a la fagocitosis. Cuando
aumentan los radicales libres, se promueve el daño neuronal. Apoptosis:
muerte celular inducida por radicales libres. Excitotoxicidad: acción
...
volumen cerebral. Hallazgos microscópicos: placas amiloides
\(estructuras extracelulares con centro de proteína beta amiloide
rodeado de axones y dendritas atróficas, su densidad no guarda relación
con el deterioro cognitivo, son más numerosas en pacientes con demencia
tipo Alzheimer, sobre todo en corteza e hipocampo), enredos
...
etc). El encare clásico de \"Delirio Alcohólico Subagudo\" no da cuenta
de todas las situaciones vinculadas al alcohol y la nomenclatura está en
desuso. El DASA, nosográficamente, quedaría ubicado como \"Delirium
inducido por alcohol\" \(por la existencia de confusión mental). Los
diferentes cuadros posibles son:
...
#block[
#strong[Delirio alcohólico subagudo]
...
temas eróticos o de celos. Predominio de alucinaciones visuales \(como
en el sueño). Pueden haber alucinaciones auditivas \(amenazantes,
...
formas alucinatorias no oníricas o sin confusión \(Marchand) o formas
con automatismo mental \(eco del pensamiento, comentario de actos, s/t
...
#block[
#set enum(numbering: "1.", start: 1)
+ Secuelas postoníricas: Regis describe 3 tiempos del despertar de los
  estados oníricos: ausencia de crítica → dudas → rectificación. Cuando
  persiste la idea → idea fija postonírica \(explica el delirio con
  detalle). Pueden haber IFPO permanentes.

+ Estados de alucinosis alcohólica: psicosis alucinatoria o síndrome de
  automatismo mental subagudo con predominio de actividad alucinatoria
  \(más auditivo que visual) sin desestructuración de la conciencia.
  BOTE, sin obnubilación, sin trastorno de memoria. Alucinosis de los
  bebedores \(Wernicke). Inicio: ilusiones, s/t en la noche \(ruidos,
  conversaciones) y rápidamente aparecen alucinaciones acusticoverbales
  con carácter de sensorialidad más acentuado. Contenido hostil
  \(insultos, amenazas, oye hablar de él en tercera persona). Poco
  frecuente alucinaciones visuales \(más ilusiones, formas amenazantes,
  sombras). Experiencia delirante \(imaginación alucinatoria). Es una
  forma de delirio vivido solamente en los datos perceptivos. Evolución
  favorable en pocos días. Si se cronifica → F20 desencadenado por EPA
  OH.
...
+ Delirios alcohólicos crónicos:
  ...
  + Delirios de interpretación: psicosis sistematizadas. Celotipia
    ...
    progresa el delirio. Mezcla de temas hipocondríacos, homosexuales,
    incestuosos latentes.

  + Delirios alucinatorios: paranoia alucinatoria de los bebedores
    \(Kraepelin). Pueden estar precedida de una alucinosis. Actividad
    alucinatoria y seudoalucinatoria muy viva. Esfera acusticoverbal o
    visual. Diálogos, susurros, comentario de actos, fotopsias. Poco
    ansiosa, alegría paradojal, intenta apartarse de las alucinaciones
    con distracción. Fabulación. Fantasía. Evolución a la indiferencia →
    demencia.

  + Delirios paranoides: evolución de tipo esquizofrénico →
    rediagnóstico.
  ]
]
...
#block[
#set enum(numbering: "1.", start: 1)
+ Psicosis polineurítica alcohólica de Korsakoff. Más frecuente en
...
+ Encefalopatía de Gayet-Wernicke: comienzo progresivo. Ansiedad,
  ...
  delirio y alucinaciones. Patognomónico: trastorno oculares \(parálisis
  de los movimientos de los globos, descenso de la agudeza visual,
  fotofobia, nistagmo, contractura de tipo meningítico). Evolución en
  10-15 días al coma y muerte. Remite con tratamiento.

+ Encefalopatía alcohólica portocava: F10 + cirrosis + trastornos de
  ...
  producción, disminución de la eliminación por insuficiencia hepática)
  → interrupción del ciclo de Krebs.
]

#block[
#strong[Demencias alcohólicas]
...
#block[
#strong[Fenómenos acompañantes Excitación psicomotriz. Humor y
afectividad.]
...
====== Síndrome conductual
+ Cuadro actual: lo relacionado al MC, CB y pragmatismos.
+ Curso de vida: trastornos conductuales si existen. Alcoholista de larga data con pérdida del control e impulso a la embriaguez con elementos de abstinencia que calman con la ingesta (nombrarlos), con elementos que hablan de tolerancia (nombrarlos) o tolerancia inversa (nombrarlos), con consumo persistente a pesar de las consecuencias del mismo.
...
- Gamma Tolerancia, dependencia, abstinencia, falta de control, impulso a la embriaguez. Bebedor irregular, acoholómano.
...
==== Diagnósticos diferenciales
<_diagnósticos_diferenciales_3>
- DELIRIUM TREMENS: no pensamos ya que en este cuadro confusional agudo
  existe: \> gravedad con deshidratación, alteraciones HE, alteraciones
  NV con temperatura de 40º, taquicardia, sudoración, PA. • temblor
...
- Alucinosis alcohólica: que también ocurre ante supresión/aumento de la
  ...
  alteración leve de la conciencia, las alucinaciones son sobre todo
  auditivo-verbales, de amenaza alucinatoria, hay cierta crítica a ellas
  y carece de correlato somático.
...
==== Diagnóstico etiopatogénico y psicopatológico
<_diagnóstico_etiopatogénico_y_psicopatológico_3>
- Abstinencia
...
#block[
#strong[De la intoxicación crónica]
...
Existirían rasgos que favorecen \(terreno de personalidad
predisponente): dependencia, intolerancia a las frustraciones, trastorno
profundo de vínculos, abandono, mal manejo de la agresividad. También
son predisponentes: cuadros afectivos previos, ansiedad. Marcar si
existe:
...
- conductual: refuerzo positivo/negativo. \* social: refuerzo social,
  subculturas. \* genéticos: riesgo x 4 en hijos de alcohólicos, si hay
  AF: inicio precoz, más trastornos conductuales, peor pronóstico,
  formas más graves. \* biológicos: neurotransmisores. \* psicoanálisis:
  Superyo punitivo, fijación a etapa oral. \* comorbilidad: depresión,
  ansiedad, trastornos de la personalidad. \* historia infantil:
...
- PyM: ictericia, equimosis, anemia, hidratación, estigmas de
  ...
  \(asociación lesional) \* ABD: hepatomegalia, esplenomegalia,
  circulación colateral \(HT portal, ascitis). \* PNM: parálisis
  horizontal de la mirada, tono muscular y sensibilidad, parestesias
  \(polineuropatía de MMII, velocidad de conducción). Flapping o aleteo,
  rueda dentada, hiperreflexia, Síndrome cerebeloso \(marcha). Fondo de
  ojo.
...
- GGT \(alta especificidad pero baja sensibilidad), dado que la
  ...
  consumo). Pueden haber valores elevados en hepatopatías no alcohólicas
  o x fármacos.

- Volumen corpuscular medio \(alta especificidad, baja sensibilidad):
  aumentado en el 70% de pacientes alcohólicos, con consumos superiores
  a 60 g/día x períodos prolongados. Luego de la suspensión de la
  ingesta, disminuye a los 90 días aproximadamente. Aumenta nuevamente
  en caso de que se reinicie la ingesta.
...
- F10.52 Trastorno psicótico inducido por alcohol \(con alucinaciones) /
  Alucinosis alcohólica Según gravedad: Risperidona VO o Haloperidol IM

- F10.6- Trastorno amnésico inducido por alcohol Vitaminoterapia
  \(complejo B) + Nootrópicos a dosis altas.

- F10.73 Demencia inducida por alcohol. Vitaminoterapia + tratamiento de
  demencias.
...
Usar NLS \(Levomepromazina 25 mg i/m a repetir, sabiendo de cierto
riesgo dado que baja el umbral convulsivo) o Tiapridal 1 amp \(100 mg)
cada 6-8 horas. Luego que ceda la intoxicación, pasamos a
benzodiacepinas para evitar el síndrome de abstinencia. b. Abstinencia:
Por ser el alcoholismo favorecedor de una malabsorción crónica,
comenzaremos con vía intramuscular: Lorazepam 1 amp \(4 mg) cada 6-8 hs.
Tan pronto como sea posible usaremos la vía oral, teniendo 2
posibilidades:
...
- Si no hay elementos en contra: Diazepam 15-20 mg/día en 3 dosis v/o
  ...
  más corta y sin metabolitos activos como el Lorazepam 2 mg c/4 hs v/o
  a regular por evolución \(no afectado su metabolismo por 1º paso
  hepático, no tiene metabolismos activos, no tiene efecto acumulativo).
  En caso de que el síndrome de abstinencia sea intenso y domine el
  cuadro, existen pautas de tratamiento con benzodiacepinas, una de las
  más usadas es con Diazepam en un esquema de 4 días: \* Día 1: 20 mg
  cada 6 horas \* Día 2: 20 mg cada 8 horas \* Día 3: 20 mg cada 12
  horas \* Día 4: 20 mg en 24 horas. Alternativas: Clometiazol,
  Tetrabamato.
...
<_a_largo_plazo_2>
#block[
#strong[Tratamiento de la dependencia de alcohol]
...
+ Orgánicas:
  ...
  #block[
  #set enum(numbering: "a.", start: 1)
  + digestivas: hemorragias, esofagitis, gastritis, cirrosis, ulcus,
    pancreatitis

  + hematológicas: anemia

  + neurológicas: polineuritis, traumatismos, degeneración cerebelosa,
    miopatía
...
+ Psiquiátricos:
  ...
  #block[
  #set enum(numbering: "a.", start: 1)
  + intoxicación aguda y sus complicaciones \(accidentes, homicidios,
    suicidios)
...
+ Sociales: deterioro FA SE SO LA Estado de vulnerabilidad encefálica
  que puede desencadenar nuevos episodios ante aparición de factores
  comórbidos con los consiguientes riesgos y complicaciones. Depende de
  la compensación del trastorno \(por ej. CV).
]

== Trastornos por consumo de opioides
<_trastornos_por_consumo_de_opioides>
=== Notas clínicas
<_notas_clínicas_4>
==== Evaluación del Trastorno por consumo de opioides
<_evaluación_del_trastorno_por_consumo_de_opioides>
...
Scale), SOWS \(Subjective Opioid Withdrawal Scale), COWS \(Clinical
...
- Internación: considerarlo si hay comorbilidad con otros trastornos por
  consumo de sustancias \(alcohol, sedantes, hipnóticos). Considerarlo
  aún en conexto de consumo que parezca no problemático.
...
Buprenorfina: primera línea \* Metadona: pacientes bajo supervisión o
con falla de tratamiento con buprenorfina. Contexto: internación. \*
...
aumentarse de forma rápida a dosis que sean eficaces para 24 horas \(de
a 8 mg x día). Máximo: 24 mg/día.
...
antes de empezar con Naltrexona \(no debe haber dependencia). Puede
hacer un test de dosis inicial para comprobar que no haya dependencia
física.
...
Buprenorfina \(alternativa a la metadona): comenzar cuando hayan
sintomas de abstinencia leves-moderados, antes de que sean severos \(6
horas aproximadamente luego de la última dosis de un opiode de acción
corta y 24-48 horas luego de un opioide de acción prolongada). Se
recomienda hospitalización. Luego de la inducción aumentos de 5-10 mg x
semana. No requiere de ajuste de dosis. No se recomienda la
discontinuación antes de una cesárea electiva ya que aumenta el riesgo
de abstinencia fetal.
...
adicionales \(tales como anestesia regional). La decisión de
discontinuar la buprenorfina antes de una cirugía electiva debe ser
hecha en conjunto con anestesista. De hacerlo debe ser 24-36 horas antes
de la cirugía recomenzando en el postoperatorio luego de que no se
necesite analgesia con agonistas opioides postoperatoria.
...
#block[
#strong[Comorbilidad psiquiátrica]
...
- Nielsen, S., Larance, B., & Lintzeris, N. \(2017). Opioid agonist
  treatment for patients with dependence on prescription opioids. Jama,
  317\(9), 967-968. \* Nielsen, S., Larance, B., Degenhardt, L., Gowing,
  L., Kehler, C., & Lintzeris, N. \(2016). Opioid agonist treatment for
  pharmaceutical opioid dependent people. Cochrane Database of
...
- Veilleux, J. C., Colvin, P. J., Anderson, J., York, C., & Heinz, A. J.
  \(2010). A review of opioid dependence treatment: pharmacological and
  psychosocial interventions to treat opioid addiction. Clinical
  psychology review, 30\(2), 155-166.

= Trastornos psicóticos
<_trastornos_psicóticos>
== Esquizofrenias
<_esquizofrenias>
=== Notas clínicas
<_notas_clínicas_5>
...
verbales, frases huecas y ampulosas. Aparición precoz de
\"debilitamiento intelectual\".

===== Catatonía de Kahlbaum
<_catatonía_de_kahlbaum>
...
<_kraepelin_y_la_demencia_precoz>
...
<_formas_clínicas_hebefrénica_postpuberal_puerilismo_pasividad>
...
- Sistemática : inicio insidioso de un delirio de persecución progresivo
  ...
  agregan alucinaciones auditivas e ideas de influencia. Pragmatismo
  laboral conservado

- Expansiva: megalomanía exuberante con exaltación del humor, erotomanía
  \(s/t en mujeres), también ideación delirante mística, aparición más
  precoz de alucinaciones y alteración pragmática pero se conserva un
  comportamiento dócil y razonable sin desintegración de la
  personalidad.
...
autores : Stransky \(ataxia intrapsíquica), Chaslin \(locura
discordante). Pese a utilizar el término en singular para él es evidente
que se trata de un grupo que incluye varias enfermedades. Concepto que
vuelve más imprecisos los límites con los trastornos de la personalidad
y con la normalidad, permitiendo que los pacientes sean considerados
personas menos extrañas y cercanas a la experiencia normal
...
de paso\". Al reanudarse la corriente de pensamiento las ideas que
surgen guardan escasa o nula relación con las precedentes, a veces el
paciente lo atribuye a influencia extraña. Conexiones accidentales,
...
===== Hebefrenia
<_hebefrenia>
Característica tendencia al deterioro y la \"demencia\" / para Bleuler
la cuestión de la edad es irrelevante / sería una categoría residual
donde previa-mente hay que descartar otros subtipos
...
interior), Bleuler \(esquizofrenia) Metáforas : \"máquina sin
combustible\" \(Chaslin) / \"libro desprovisto de encuadernación\" cuyas
páginas están mezcladas y en desorden, pero sin que ninguna falte
\(Anglade).
...
realidad tratando de alcanzar el máximo de valor pragmático \"No busca
ni ser comunicado a los demás de una manera comprensible, ni dirigir la
...
Síntomas \(+): alucinaciones / delirio / trast formales del pensam
\(buena respuesta a NL)
...
\(a) sd tipo I : \"esquizofrenia aguda\" : sínt \(+) / alt en
transmisión dopaminérgica / potencialmente reversibles / predictores de
buena respuesta al tto NL / pueden ser seguidos x el desarrollo de sd
tipo II o presentarse combinados
...
Andreasen : esquizofrenia \(+) / \(-) : pobreza del discurso, del afecto
y del contenido del pensam, retardo psicomotor y anhedonia / mixta /
creó escalas SANS y SAPS

=== Encare
<_encare_5>
==== Agrupación sindromática
<_agrupación_sindromática_4>
===== Síndrome disociativo-discordante
<_síndrome_disociativo_discordante>
...
- Impenetrabilidad: hermetismo y tonalidad enigmática que caracteriza al
  desorganizado mundo del sujeto por lo cual no se encuentra sentido a
  sus expresiones. Pensamiento oscuro, enmarañado, incoherente, caótico,
  con pérdida de la secuencia asociativa lógica, con pararrespuestas,
  alteraciones fonéticas, sintácticas y semánticas, neologismos.
  Reacciones afectivas incomprensibles, inmotivadas, respuestas
  emocionales paradojales.

- Desapego: vuelta del sujeto sobre sí mismo, con abandono a la
  ensoñación interior , en la cual afectos e intereses no se vuelcan en
  la realidad. Ambos síntomas \(impenetrabilidad y desapego) evocan la
  retracción a un mundo autista. A nivel del lenguaje, se produce un
  desvío de su legítima función, no estando destinado a establecer
  ...
  #strong[atimormia] \(desinterés afectivo, apariencia desvitalizada,
  inercia aparente, interrupción del continuo intercambio entre el mundo
  y el sujeto).
...
- Ambivalencia: antagonismo simultáneo y sucesivo de 2 experiencias
  ...
  Ambitendencia: ambivalencia conductual.
...
<_síndrome_delirante_o_síndrome_de_alteración_del_pensamiento>
...
<_síndrome_de_automatismo_mental>
...
<_síndrome_del_humor_y_la_afectividad>
...
#block[
#set enum(numbering: "A.", start: 1)
+ Hebefrénico: Adolescente o adulto joven \(15-25 años), SDD, jovialidad
  pueril, desorganización conductual, irresponsables, imprevisibles,
  rápido deterioro, no predomina el delirio \(transitorio y
  fragmentario).

+ Catatónico: Según el síndrome catatónico. Cuadro de inercia sobre el
  que sobrevienen bruscos brotes de impulsividad. Estuporosa
  \(reacciones violentas), agitada \(violencia extrema), catanonismo
  \(discordancia PM).

+ Paranoide: \> 20 años \(adulto joven), cuadro centrado en el delirio
  paranoide, aunque existen elementos DD, pese al tipo de evolución no
  existe deterioro marcado.

+ Simple: Pérdida insidiosa del interés o motivación, ambición o
  iniciativa.

+ Indiferenciado CIE-10, DSM, sin claro predominio de ningún tipo.
]
...
comportamiento desorganizado o catatónico / sínt negativos
\(aplanamiento afectivo / pobreza del discurso / apatía / retraimiento
social) . disfunción social / ocupacional . \> 6 meses . exclusión de :
...
<_diagnóstico_diferencial>
- Con PDA: consideramos que se trata de un brote delirante,
  descompensación aguda de una enfermedad crónica. Hay SDD, hay períodos
...
- Con otros delirios crónicos:
  ...
  - Paranoia: que descartamos ya que la paranoia presenta un delirio
    ...
    mundo autista como en nuestro paciente.

  - Parafrenia: que descartamos porque la parafrenia se caracteriza por
    un pensamiento paralógico, fantástico, a mecanismo imaginativo, pero
    s/t por el mantenimiento de los pragmatismos, sin deterioro, con la
...
==== Diagnóstico etiopatogénico y psicopatológico
<_diagnóstico_etiopatogénico_y_psicopatológico_4>
===== Etiopatogenia
<_etiopatogenia>
...
estructurales inespecíficas en la TAC y RNM con de ventrículos laterales / PET y SPECT \( utilización de glucosa por el cerebro y valorac del
...
por la cual raramente ocurren ef 2º EP \(acatisia, disk aguda,
...
+ riesgo de agranulocitosis : 2% en 1er año de trat / enteramente
  ...
  regular / CON-SENTIMIENTO INFORMADO / hemograma semanal x 18 sem y
  luego mensual / ef 2º idiosincrásico / 75% de casos reportados entre 4
  -18 sem
]

Valoración pre tto : anamnésico : AP de agranulocitosis por drogas - alt
MO / hemograma c/ fórmula leucocitaria \(rango normal : leucocitos 4 a
11 mil - neutrófilos 2500 a 7500 / AP neurológicos \( s/t convulsiones) / evaluación cardiológica

#block[
#set enum(numbering: "1.", start: 1)
+ contraindicaciones : AP de agranulocitosis x dro-gas / recuento
  leucocitario bajo previo \(\< 3,5 x 10 a la nueve) / trast M.O. actual
  o en AP / uso concomitante de otro supresor de M.O. \(cbz, ojo c/
  fenotiazínicos) . posología : inicio por 25 mg / día probar tolerancia
  \(sedación y P.A.) y aumentos diarios de 25-50 mg hasta 300 / día en
  7-14 días / eficacia antipsicótica entre dosis de 300 y 450 mg / día /
  dosis máx recomendada 600 mg, a/v requieren hasta 900 . Hipotensión
  ...
  agregar valproato siempre \(anti-convulsivante que no aumenta riesgo
  de agranulocitosis) / riesgo : enf cerebral previa - dosis : 4-5 .
  luego de benef terap máx se puede pasar a mantenimiento titulando
  hacia abajo hasta un rango de 150- 300 / día . índice de resp en
  resistentes a tto convencional : 30 . luego de beneficio terap máx se
  puede pasar a do-sis de mantenimiento titulando hacia abajo hasta un
  rango de 150-300 mg / día . el índice de respuesta en ptes resistentes
  a tto convencional es de mejoría de 30 . respuesta pobre luego de 6
  meses : niveles plasmáticos : 350 nanogr / ml \(s/t si es fumador) .
  ideal descenso lento c/ wash out de 24 hs y titulación lenta de
  Clozapina / si hay graves elementos de des-compensac se pueden
  superponer / post depot espe-rar 4-6 sem / adición de otro NL \>
  riesgo de ef 2º EP . \"olvido de tomar\" : \< 48 hs : reiniciar tto c/
  \= dosis / \> 48 \= patrón que esquema inicial . interrupción del tto
  LENTA a razón de 25-50 mg/d en período de 1-2 sem . psicoeducación :
  reporte inmediato de cualquier sg de infección . monitoreo
  leucocitario : semanal en 1ª 18 sem / luego mensualmente / 4 sem post
  a discontinuación . si disminuye x debajo de 3500 o hay sgs de
  ...
  inicial / si encontramos leucocitos entre 3 mil-3500 o neutrófilos
  entre 1500-2 mil realizar 2 hemogramas por semana . efectos 2º \( por
  acc sobre receptores muscarínicos, adrenérgicos, anti H1) . sedación y
  fatiga : usualmente transitorio / reducir dosis, titulación lenta /
  descartar interacc c/ OH u otras drogas / concentrar mayoría de dosis
  en la noche
...
que puede \(¿?) signos de catatonía según la tolerancia del paciente
\(si no recibió nunca). Para la impulsividad catatónica en la
esquizofrenia catatónica: Clonazepam 2 mg VO c/8 hs, rápida sedación,
teniendo cuidado con el aumento del umbral convulsivo. Ir aumentando de
a 2 mg/día hasta 16 mg: 4 - 4 - 8).
...
más bajo potencial evolutivo autista \(las hebefrénicas son más
rápidas).
...
- Menor edad de comienzo: ley de masividad \* Bajo nivel intelectual \*
  ...
  Poca colaboración familiar \* Perfil de adhesión pobre al tratamiento  / antecedentes de abandono de la medicación \* Consulta tardía \* Mala
...
<_encare_6>
==== Diagnóstico positivo
<_diagnóstico_positivo_5>
===== Nosografía clásica
<_nosografía_clásica_3>
#block[
#strong[Esquizofrenia Síndrome disociativo-discordante o elementos de
síndrome]
...
+ Paranoide: adulto joven, cuadro centrado en el delirio paranoide,
...
\[aplanamiento afectivo, alogia, abulia\]). \(1 síntoma solo si las
ideas delirantes son extrañas). O AAV y SAM.
...
\(en remisión parcial/total) • menos de 1 año desde el inicio de
...
+ Paranoia: que descartamos ya que la paranoia presenta un delirio
  ...
  autista como en nuestro paciente. B. Parafrenia: que descartamos
  porque la Parafrenia se caracteriza por un pensamiento paralógico,
  fantástico, a mecanismo imaginativo, pero s/t por el mantenimiento de
  los pragmatismos, sin deterioro, con la característica bipolaridad con
  la que coexisten el polo delirante y el polo adaptado a la realidad
  \(edad 30-35 años).
]
...
Preferimos el uso de benzodiacepinas frente a los neurolépticos sedativos:
- Lorazepam i/m
- Clonazepam 2 mg v/o c/8.

De segunda línea: levomepromazina: 25 mg i/m H 8:00 y 50 mg i/m h: 20:00.
...
- Casos de evolución desfavorable reiterada con AP de buena respuesta a ECT

Secuencia preferible: NLA → NLT → ECT → Clozapina. Cada prueba terapéutica por 6-7 semanas (Clozapina x 12 semanas). En cada cambio suprimir gradualmente el anterior mientras se inicia gradualmente el siguiente.
...
= Trastornos del humor
<_trastornos_del_humor>
== Trastornos del humor: generalidades
<_trastornos_del_humor_generalidades>
...
#block[
#set enum(numbering: "1.", start: 1)
+ mixto 2. inducido por sust 3. enf orgánica
]
...
est I y II \(disforia-manía) / est III \(imposible diferenciar) / est II
y I \( disforia-manía)
...
<_etiopatogenia_y_psicopatología>
===== Etiopatogenia
<_etiopatogenia_4>
\=\=\=\=\=\= Biológico
...
#block[
#set enum(numbering: "1.", start: 1)
+ alt del sueño \(en + ó -), apetito, impulso sexual y cambios
...
+ MUY genético s/t bipolar / reactivado por el ambiente : kindling
  ...
  + luego del 4º : no hay evidencias . fenóm vinculado al uso de cocaína
    . \> jóvenes \< necesidad de estímulo / \> + resist por lo que se ha
    planteado la profilaxis del kindling en ptes c/ vulnerabilidad
    genética mediante CBZ que luego se suspendería / el estím no crece
    la respuesta sí . post menopausia \= tasa de depre que en hombres /
    \> nº de depre en mujeres es entre post pubertad y pre menopausia /
    el reemplazo hormonal con estrógenos tiene otras ventajas vinculadas
    al trast posmenopáusico pp dicho \(ej osteoporosis)
  ]

+ bioquímico: desequilibrio a/n de NT con hipersensibilidad en
...
complicar evolución favorable del episodio depresivo \(muerte o enf de
3º significativos) / cotidianos : manejo de la economía del hogar / alt
...
#block[
#set enum(numbering: "1.", start: 1)
+ retorno sobre sí de la agresividad : cond peligrosas / equivalentes
  suicidas / id de AE / IAE 2. inhibición y pasividad : repliegue sobre
  sí mismo / desinterés / clinofilia / enclaustrado en habitación 3.
  huída y distanciamiento
]
...
Existe una desestructuración ético-temporal de conciencia \(de 1º
grado), con pérdida de la capacidad de adaptación y moderación a las
...
RESISTENCIA : falla en remisión completa en 3 ensayos \(incluyendo ISRS
y TCA) por 12 sem c/u a la máx dosis tolerada
...
hiperdefecación), bupropión \(no provoca alt sex), Venlafaxina
\(cefaleas, náuseas, HTA)
...
actuando sobre la EPM y la ideación megalomaníaca \(síntomas
psicóticos). Ajustaremos la dosis, pudiendo llegar a 15 mg/día si la
mejoría clínica no es satisfactoria. Estaremos alertas a efectos
secundarios extrapiramidales. Si aparecen \(rigidez, rueda dentada,
bradiquinesia, temblor) concentraremos la dosis en la noche ya que no se
producen durante el sueño. Si con esa medida no podemos controlarlo,
agregaremos un antiparkinsoniano de síntesis como el Biperideno a dosis
de 2 mg v/o H8 y H14. Si es menor de 35 años, sexo masculino lo
agregamos de entrada por mayor riesgo de presentar distonías agudas. Si
aparecen: 5 mg i/m con lo que ceden inmediatamente.
...
\(letargia, fatiga, debilidad muscular y temblor fino distal),
polidipsia y poliuria son todos fenómenos reversibles y transitorios.
Indicaremos abundantes líquidos v/o. Estaremos atentos a la aparición de
estos síntomas. Controlaremos la aparición de estos síntomas.
Controlaremos la aparición de signos incipientes de toxicidad \(ataxia,
...
\"cicatrices\" de la enf que deben trabajarse en la terapia
\(pragmáticas, autoestima)
...
disminuyendo consumo proteico; si persiste agregar hidroclorotiazida
\(25 a 75 mg) y bajar Li a la mitad para compensar aumento de la
reabsorción / tb amilorida \( ahorrador de K)
...
- refract a Li \* dosis inicio : 200 c/ 8 hs y aumentar hasta 1200 mg \[
  6-12 microgr / ml \] \* ef 2º : dosis depend : leuco y trombopenia
  leves, \> enz hepáticas, hipoNa, diplopía, ataxia, fatiga, visión
  borrosa, temblor,\> peso, erupc cutáneas, náuseas, vóm, retención de
  líquidos / idiosincrásicos : corazón \(ef quinidinosímil, control en
  cardiópatas), agranulocitosis, anemia aplásica, insuf hepática \*
  hemograma \(c/ lám y recuento plaquetario) y funcional hepático : c/ 2
  sem x 2 meses y luego c/ 3 meses ya que discrasias y hepatopatías
  tienen lugar s/t en 1º 3 a 6 meses \* inductor de Cit P450 : induce su
  pp metabolismo y otros metabolismos hepáticos, por lo tanto múltiples
  interacciones \* CBZ no mantiene sus efectos c/ el tiempo, puede
  disminuir en 1 ó 2 años

==== Evolución y pronóstico
<_evolución_y_pronóstico_7>
===== TDM
<_tdm>
...
#block[
#set enum(numbering: "1.", start: 1)
+ trast mental: ep depresivo 50 2. sexo: 1 y 2 + frec en hombres, 3 +
  frec en mujeres 3. edad: + viejos 4. enf orgánicas 5. E. civil 6. life
  events 7. genético-biológico \(5 HT)
]
...
#block[
#set enum(numbering: "A.", start: 1)
+ Igual que manía B. Igual que manía C. Cambio con respecto a humor
...
#block[
#set enum(numbering: "A.", start: 1)
+ Se cumplen criterios para episodio maníaco y para episodio depresivo
...
#block[
#set enum(numbering: "A.", start: 1)
+ historia de 2 años de varios episodios hipomaníacos + episodios
  depresivos que no cumplen criterios de EDM \

+ Nunca asintomático x más de 2 meses \

+ Dos primeros años sin EDM, episodio maníaco o mixto \(si aparecen
  luego de los 2 años, codifican los 2 trastornos) \

+ Descartar esquizoafectivo, esquizofrenia, esquizofreniforme, trastorno
  delirante \

+ Descartar sustancias, enfermedad médica \
...
+ Manía secundaria a causa orgánica: si el cuadro se presenta a edad
  ...
  esclerosis múltiple, corea, tumores, TEC. .. Infeccionsa:
  ...
  \(desestructuración de conciencia). En contra: menor profundidad de la
  desestructuración, delirio onírico en la confusión, falta de
...
#block[
#strong[Trastorno de la personalidad]

]
Tanto DD como comorbilidad.

==== Diagnóstico etiopatogénico y psicopatológico
<_diagnóstico_etiopatogénico_y_psicopatológico_7>
...
+ Genética: hay una carga genética predisponente, dada la frecuencia de
  AF de trastornos afectivos, alcoholismo, IAE, comprobándose
  asociaciones con algunos cromosomas específicos. Pero la concordancia
  entre gemelos no es del 100 . Constitucional: desde las descripciones
  clásicas se plantea la asociación con el biotipo pícnico
  \(Kretschmer), lo cual se ve reforzado por la constatación de una
  mayor prevalencia de alteraciones metabólicas. . Hipótesis
  ...
  realizada por el sistema serotoninérgico. Existiría una disregulación
  en estas vías. . Existiría una alteración de la carga alostérica al
  estrés, es decir la capacidad de conservar la estabilidad. Sería una
  enfermedad de la respuesta, del retorno a la normalidad.

+ Se postula la existencia de un fenómeno de kindling
...
+ Se detectan también cambios neuroendócrinos en: CRH, RCRH, VSP, ACTH,
  cortisol.
]
...
#block[
#strong[Con miras a posibles tratamientos]
...
de intoxicación por litio), hemograma \(litio da leucocitosis), ECG
\(por efectos sobre la conducción cardíaca). Descartar estados que
lleven a balance negativo de Na \(dieta hiposódica, diuréticos) ya que
en su eliminación, el LI se intercambia por Na a nivel renal y un
déficit de este ion puede llevar a un aumento de la litemia con el
consiguiente riesgo de intoxicación.
...
Tx \(para descartar aneurisma de aorta). Fondo de ojo/TAC: para
descartar HTEC. En algunos casos puede plantearse la realización de EEG.
En pacientes añosos y según el caso clínico puede solicitarse una
...
\(por determinar movilización enzimática y potencial toxicidad
hepática).
...
+ Objetivos inmediatos: remitir rápidamente el cuadro actual, descartar
  causa orgánica, prevenir complicaciones. . Objetivos mediatos:
  compensar la enfermedad de fondo, prevenir futuras recaídas, prolongar
  los períodos de remisión, reinsertar al paciente en su mejor nivel de
  funcionamiento.
]
...
#block[
Regla general: LIT en manía típica, DVL en el resto \(por se de más
fácil manejo).
...
- Segunda línea: haloperidol IM \(5 mg/dosis, máximo: 15 mg/día),
  haloperidol + midazolam \(7.5 mg/dosis, máximo: 15 mg/día). En Uruguay
  no contamos con: asenapina SL, prometazina IM, risperidona TDO,
  ziprasidona IM.
...
Olanzapina \(primera línea, con o sin síntomas psicóticos): iniciando
con 5 mg/día en toma única, aumentando a 10 si hay buena tolerancia,
...
previas dado que éstas aumentan el umbral convulsivo \(se puede
sustituir por Levomepromazina). La dosis de litio de la mañana se
postergará por mayor riesgo de confusión mental y amnesia post ECT.

#block[
#strong[Tratamiento de la enfermedad de fondo]
...
neurológica inespecífica \(letargia, fatiga, debilidad muscular y
temblor fino distal), polidipsia y poliuria, son todos fenómenos
reversibles y transitorios. Indicaremos abundantes líquidos v/o.
Estaremos atentos a la aparición de estos síntomas. Controlaremos la
...
- Intoxicación grave: convulsiones, coma, shock, fasciculaciones
  ...
  #footnote[Osés, I., Burillo-Putze, G., Munné, P., Nogué, S., &
  Pinillos, M.A.. \(2003). Intoxicaciones medicamentosas \(I):
  Psicofármacos y antiarrítmicos. Anales del Sistema Sanitario de
  Navarra, 26\(Supl. 1), 49-63].
...
\(potencial teratogénico de algunos fármacos, aumento de posibilidades
de descompensaciones vinculadas a ciclos reproductivos).
...
mejoría \(ver esquema previo con secuencia de uso de fármacos de 1a, 2a
y 3a linea).
...
riesgo; agresividad UISP, alcoholismo, sexualidad \(HIV, VDRL, HVB,
HVC). Comorbilidad médica \(insuficiencia renal, enfermedades
cardíacas).
...
- Simple: IPM + poco DM \(\"con conciencia\"). Predomina la IPM con
  ...
  depresión \"neurótica\" o \"reactiva\"). \* Franca: IPM + DM \(dolor
  ...
  frotarse las manos, sollozar, gemir). \* Delirante: Sº depresivo + Sº
  delirante. \* Estados mixtos: presencia simultánea o rápidamente
  alternante de síntomas depresivos y síntomas de exaltación del humor.
  Clínicamente: turbulencia, agitación, perplejidad, irritabilidad /
  disforia.

#block[
#set enum(numbering: "A.", start: 1)
+ PMD unipolar: AF de cuadros afectivos o alcoholismo; AP de cuadros
  similares con restitución ad-integrum. No existen episodios previos de
  manía o hipo-manía B. PMD: similar, pero en la evolución presentó uno
  o más episodios de exaltación del humor.
]
...
- Catalepsia / Inmovilidad motora: incluye flexibilidad cérea o estupor.
  Inercia, actitudes de pasividad y automatismo \(latencia en
...
#block[
#set enum(numbering: "A.", start: 1)
+ Anhedonia y/o humor no reactivo B. 3 o + de 6: \* Cualidad distintiva
  del estado de ánimo. \* Peoría matutina \(polo matinal) \* Depertar
  precoz \(2 horas antes de lo habitual) \* Inhibición o agitación
  psicomotriz \* Anorexia significativa / pérdida de peso \* Culpa
  excesiva o inapropiada
]
...
#block[
#set enum(numbering: "A.", start: 1)
+ Humor reactivo B. 2 o + de 4 \* Aumento de peso o apetito \*
...
#block[
#set enum(numbering: "A.", start: 1)
+ Relación temporal sostenido entre episodio afectivo y épica del año.

+ REmisión total o cambio de polaridad en determinada época del año. C.
...
#block[
#strong[Diagnóstico nosológico]

]
TDM - TDM-R - TB I - TB II Cursando episodio actual X.

Trastorno Depresivo Recurrente: más jóvenes, puede estar precedido por
distimia \(depresión doble). Mayor porcentaje de antecedentes
familiares. Importante realizar este diagnóstico por cambios al plantear
tratamiento.

==== Diagnósticos diferenciales
<_diagnósticos_diferenciales_6>
===== Nosografía clásica
<_nosografía_clásica_9>
#block[
#set enum(numbering: "1.", start: 1)
+ Depresión sintomática de un trastorno médico o consumo de sustancias.
  ...
  la evolución no es la esperada, hay mala respuesta al tratamiento o
  los hallazgos del EF nos hacen sospechar. .. Neoplasmas: genital,
  mamas, cabeza de páncreas, pulmón. .. Fármacos: neurolépticos,
  reserpina, alfametildopa, betabloqueantes, ACOs. .. UISP: OH, BZD,
  anfetaminas / cocaína. Depende de tipo: abstinencia, intoxicación,
  dependencia, abuso.
  ...
  + Endócrino: hipotiroidismo, encefalopatía hepática, efermedad de
    ...
    Cuadro más leve, con humor reactivo, mejora con el contacto de la
    entrevista, oscila, permite vibrar con el relato, se establece mejor
    rapport, pedido de ayuda, sin síntomas psicóticos, sin dolor moral.
    Está ligada a acontecimientos vitales. . Otras psicosis agudas: ..
    Otras formas clínicas de melancolía:
    franca/simple/ansiosa/estuporosa/delirante. .. Manía \(en caso de
    estados mixtos). Si bien comparte el nivel de desestructuración de
    la conciencia, la clínica es opuesta a la depresiva. .. PDA \(en
    caso de melancolía delirante). En la melancolía la experiencia
    delirante es secundaria al estado de ánimo. No hay polimorfismo. El
    nivel de desestructuración de la conciencia es menor.

  + Confusión Mental: descartado, pues el paciente está BOTE. . Psicosis
    crónicas .. Depresión como debut clínico de Demencia. Tienen el
    común algunos síntomas cognitivos \(atencionales, memoria a corto
    plazo, bradipsiquia, indiferencia al entorno). Pero nos aleja del
    diferencial la presencia de AF y AF afectivos, ausencia de AP de
    trastornos de las funciones instrumentales, simbólicas y psíquicas
    superiores. .. Esquizofrenia: lo descartamos por no haber
    clínicamente un síndrome disociativo-discordante, ni un existir
    autista, ni alteración de los pragmatismos fuera del episodio. La
    inhibición psicomotriz y la indiferencia pensamos que son
    secundarias al cuadro afectivo. .. Depresión en una Paranoia
    \(cuando hay delirio incongruente con el estado de ánimo): en la
    depresión el delirio carece de continuidad con la personalidad y
    carece de la estructura paranoica típica. El orden temporal en la
    depresión es primero el síntoma afectivo y luego el delirio.
  ]
]
...
+ Causa orgánica de depresión: .. Endócrina: hipotiroidismo, Cushing,
  ...
  neurolúes, HIV 2. Inicio de deterioro demencial \(en pacientes \> 65
  años) . Cuadros Delirantes: • Agudo: PDA, confusión. • Crónico:
  delirios crónicos: AP. . Estupor: .. Confusiónal: organicidad,
  elementos de infección, oscilación rápida estupor-agitación, no existe
  catalepsia .. Catatónico de origen esquizofrénico: precedido de SDD,
  MC es absurdo/impulsivo .. Histérico . Ansiosas: diferencial con
  neurosis.
]

==== Diagnóstico etiopatogénico y psicopatológico
<_diagnóstico_etiopatogénico_y_psicopatológico_8>
===== Etiopatogenia
<_etiopatogenia_5>
Se postulan 3 factores que interactúan en la patogénesis de la depresión
: \* Factores internalizantes: por ejemplo genética y neuroticismo
#footnote[Sullivan, P.F., Neale, M.C., Kendler, K.S., 2000. Genetic
...
Psychiatry 163, 2141–2147.
#link("https://10.1176/ajp.2006.163.12.2141").]. \* Eventos adversos:
por ejemplo trauma y pérdida parental #footnote[Green, J.G., McLaughlin,
K.A., Berglund, P.A., Gruber, M.J., Sampson, N.A., Zaslavsky, A.M.,
Kessler, R.C., 2010. Childhood adversities and adult psychiatric
disorders in the national comorbidity survey replication I: associations
with first onset of DSM-IV disorders. Arch Gen Psychiatry 67, 113–123.
#link("https://10.1001/arch") genpsychiatry.2009.186.].

#block[
#strong[Biológico \* Hereditario: importante penetrancia genética. \*]
...
#link("https://10.3389/fimmu.2019.01696").].

#block[
#strong[Comprensión psicológica]
...
<_psicopatología_5>
#block[
#strong[Psicoanálisis Para la depresión esta teoría se basa en las
relaciones]
...
#block[
#strong[Teoría organodinámica \(Ey)]
...
Binswanger y Ey insistieron en la estructura temporal \(tiempo
subjetivo) de la melancolía \(según TOD: 1º nivel de desestructuración
de la conciencia o ético-temporal) en la cual el sujeto está anclado en
la fatalidad del pasado y para quien el tiempo es una perspectiva de
...
- Consulta con especialistas según hallazgos clínicos. \* Interconsulta
  ...
  tiroideas: T3, T4 y TSH \* Descartar contraindicaciones relativas de
  ECT: IAM reciente, arritmias inestables \(ECG, cardiólogo), aneurisma
  de aorta \(RxTx), HTEC por proceso expansivo \(examen neurológico con
  fondo de ojo). En pacientes añosos: valoración cognitiva basal.

Marcadores de endogenicidad de la depresión \(con fines académicos, no
se piden de rutina): \* Dosificación de TSH a la estimulación con TRH:
...
- Paciente sin tratamientos previos: preferimos el uso de un ISRS, tal
  ...
  paciente añoso: Escitalopram. Estos antidepresivos actúan mediante el
  bloqueo de la recaptación se serotonina produciendo a mediano plazo
  una regulación a la baja \(desensibilización) de los autorreceptores
  5HT1a \(presinápticos) y 5HT1d \(postinápticos) de la neurona
  serotoninérgica. Estaremos atentos a la aparición de efectos
...
- Paciente bipolar: planteamos de primera línea el uso de
  ...
  comp/día, ya que hay menos chances de que se produzca un viraje en el
  humor.
...
Por tratarse de #fa-icon("paperclip") estamos ante una indicación formal de ECT (depresión mayor con síntomas melancólicos, catatónicos o psicóticos; melancolía ansiosa) ya que:
...
- El tratamiento farmacológico tiene latencia de al menos 15 días \*
  ...
  pueden no manifestarse por reticencia \* Para provocar alivio
...
#block[
#strong[Estabilizadores del humor Ver encare de Manía \(F31) para el uso
del]
...
- Psicoeducación: generar conciencia de la importancia de la adhesión al
  tratamiento como determinante del pronóstico a mediano y largo plazo.
  Se educará acerca de signos y síntomas de recaída.
...
<_factores_de_mal_pronóstico_antecedentes_de_maltrato_o_abuso_en>
...
96-104.]. . Síndrome metabólico #footnote[Pan, An, et al.
...
Diabetes care 35.5 \(2012): 1171-1180.].
...
<_trastorno_de_ansiedad_generalizada>
=== Notas clínicas
<_notas_clínicas_14>
=== Encare
<_encare_13>
==== Agrupación sindromática
<_agrupación_sindromática_12>
==== Personalidad y nivel
<_personalidad_y_nivel_12>
==== Diagnóstico
<_diagnóstico>
===== DSM IV
<_dsm_iv_4>
...
#block[
#set enum(numbering: "A.", start: 1)
+ Ansiedad/preocupación excesivas ante amplia gama de estímulos de más
  de 6 mese de duración.

+ Dificultad para controlar la ansiedad.

+ 3 o + de 6 \(en niños solo 1): inquietud / impaciencia, fatigabilidad,
  alteraciones en concentración, irritabilidad, tensión muscular,
  alteración del sueño \(IFCITA).

+ Excluye: síntomas debido a otros trastornos del eje I \(sobre todo
  trastornos de ansiedad).

+ Malestar clínicamente significativo.

+ Descartar sustancias, enfermedad médica y otros trastornos de eje I.
]

==== Diagnósticos diferenciales
<_diagnósticos_diferenciales_9>
Comorbilidad más frecuente: depresión.

==== Diagnóstico etiopatogénico y psicopatológico
<_diagnóstico_etiopatogénico_y_psicopatológico_10>
...
estrés y a afectos negativos \(neuroticismo) están asociados a ansiedad
y trastornos depresivos #footnote[Barlow DH, Ellard KK, Sauer-Zavala S,
et al.: The origins of neuroticism. Perspect Psychol Sci 2014;
9:481–496].
...
escitalopram. Alternativa: bupropion.#footnote[Slee, A., Nazareth, I.,
Bondaronek, P., Liu, Y., Cheng, Z., & Freemantle, N. \(2019).
Pharmacological treatments for generalised anxiety disorder: a
systematic review and network meta-analysis. The Lancet, 393\(10173),
768-777.]. Con menor evidencia: mirtazapina, sertralina, fluoxetina,
buspirona y agomelatina. Quetiapina: efecto marcado pero con mala
tolerabilidad. Paroxetina y benzodiacepinas: mala tolerabilidad.
...
<_trastorno_de_estrés_postraumático>
===== Rol de las benzodiacepinas
<_rol_de_las_benzodiacepinas>
...
<_trastornos_asociados_a_disfunciones_fisiológicas>
== Trastornos de la conducta alimentaria
...
==== Tratamiento
<_tratamiento_22>
Melatonina aprobada para uso en adolescentes#footnote[Wei, Sha, et al.
\"Efficacy and safety of melatonin for sleep onset insomnia in children
and adolescents: a meta-analysis of randomized controlled trials.\"
Sleep Medicine 68 \(2020): 1-8.].

Secuencia: Psicoterapia Cognitivo-Comportamental → Zolpidem →
Trazodona#footnote[MORIN, Charles M., et al. Effectiveness of sequential
...
<_trastornos_de_inicio_en_la_infancia_adolescencia>
...
+ Otras causas de estupor: .. Depresivo: más lento, precedido de
  ...
  Otras formas de esquizofrenia: hebefrénica \(predomina la jovialidad
  pueril y trastornos conductuales), paranoide \(predomina el delirio).
  . Otras psicosis crónicas: Parafrenia \(30-50 años, delirio polimorfo
  fantástico, persecutorio, megalomaníaco, a mecanismo imaginativo,
  para-lógico, bipolaridad), paranoia \(ambos carecen de evolución
  deficitaria, no condicionando retirada a un mundo autista).
]
...
<_síndrome_neuroléptico_maligno>
=== Notas clínicas
<_notas_clínicas_24>
...
<_encare_27>
==== Agrupación sindromática
<_agrupación_sindromática_21>
===== Síndrome de alteración de la conciencia
<_síndrome_de_alteración_de_la_conciencia_4>
Ver Delirium

===== Síndrome de inhibición psicomotriz
<_síndrome_de_inhibición_psicomotriz>
Estupor catatónico. Rigidez muscular generalizada \(en caño de plomo).
Aquinesia.

===== Fenómenos acompañantes
<_fenómenos_acompañantes>
...
<_criterios_propuestos_por_dsm_iv>
#block[
#set enum(numbering: "A.", start: 1)
+ Rigidez muscular intensa + fiebre + asociación temporal con
  administración de antipsicótico.

+ 2 o + de: diaforesis, disfagia, temblor, incontinencia, disminución
...
+ Descartar otras causas \(drogas, neurológicas) D. No se explica mejor
  por otro cuadro \(Síndrome catatónico)
]

===== Criterios de expertos
<_criterios_de_expertos>
