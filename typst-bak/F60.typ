...
Grupo B
- Antisocial (F60.2, Disocial): Nómade (Esquizoide, Evitativo), Malevolente (Sádico, Paranoide), Codicioso (patrón puro), Arriesgado (Histriónico), Defensor de reputación (Narcisista)
- Límite (F60.3, Inestable)
- Histriónico (F60.4): Apaciguador (Dependiente, compulsivo), Vivaz (Narcisita), Intempestivo (Negativista), Insincero (Antisocial), Teatral (puro), Infantil (Límite)
- Narcisista (F60.8, Otros): Inescrupuloso (Antisocial), Elitista (puro), Enamorado (Histriónico), Compensatorio (Negativista, Evitativo)

Grupo C
- Obsesivo (F60.5, Anancástico): Concienzudo (Dependiente), Burocrático (Narcisista), Puritano (Paranoide),Parsimonioso (Esquizoide), Acosado (Negativista)
- Evitativo (F60.6, Ansioso): Fóbico (Dependiente), Conflictuado (Negativista), Hipersensitivo (Paranoide), Autoabandonado (Depresivo)
...
Adolescente: destacar que su personalidad no está plenamente desarrollada. Conflictividad infantil Trastornos de la atención, hiperquinesia en etapa escolar.

Rasgos: pautas duraderas de percibir, relacionarse, concebir el entorno y a sí mismo que se expresan en una amplia gama de contextos sociales y personales significativos, en donde encontramos elementos de varias series (poner ejemplos de c/u):
...
- Trastorno antisocial de la personalidad. De cualquier modo investigaremos en reiteradas entrevistas, sabiendo que cada tipo comparte características con los restantes.
- Psicosis tóxica
- Trastorno de la personalidad orgánico (DSM): epilepsia parcial compleja, AP de TEC o trauma obstétrico.
- Neurosis: egodistónica, autoplástica. La conflictiva es intrapsíquica y no interpersonal.
- Depresión en adolescente: se puede presentar con trastornos de conducta. Crisis de adolescencia.
