...
- Conductas compensatorias: conductas destinadas a compensar el aumento de peso que provocaría el atracón: #strong[Purgativas: vómitos autoinducidos, laxantes, diuréticos] No purgativas: ejercicio excesivo o períodos de restricción dietética.
...
- Biológico: serotonina, NA, endorfinas, más AF de depresión.
- Psicológico: dificultad de separación, hiperaglutinación familiar, conflictiva familiar, criticismo parental.
- Social: imagen, rol y género. Expectativas sociales.

===== Psicopatología
<_psicopatología_7>
Cognitivo-comportamental: Distorsiones cognitivas, procesamiento de la información.
Psicodinámico: ausencia de objetos transicionales (cuerpo), ambivalencia, oralidad (bueno/malo)
...
- Función tiroidea
- Hormonas: #strong[Estradiol \(en mujeres) o testosterona \(hombres) si hay desnutrición \> 6 meses.] LH y FSH si hay amenorrea.
- Densitometría ósea
- Nutricionista, ginecólogo, odontólogo, gastroenterólogo, endocrinólogo.
- Eventual TAC en AN
- HCG, HIV, VDRL, perfil lipídico.
...
Tratamiento higiénico-dietético: estructuración de la alimentación (orden alimentario). Tratamiento nutricional según lo indicado por nutricionista.

_Biológico_

ISRS a altas dosis en BN o en TPA P: TCC: estilos de afrontamiento, técnicas de manejo de estrés, reestructuración cognitiva.

_Psicológico_

Entornos estructurados (permiten la observación de todas las etapas del ciclo alimentario). Terapia familiar: límites, contratransferencia.
