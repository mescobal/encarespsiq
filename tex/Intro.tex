...
\begin{wrapfigure}{r}{0.5\textwidth}
	\centering
    \includegraphics[natwidth=100,natheight=75]{copyleft.png}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.5\textwidth}
	\centering
    \includegraphics[natwidth=88,natheight=31]{cc.png}
\end{wrapfigure}
...
\begin{itemize}
\item Un tratado de psiquiatría (quizás sea más práctico en forma de compendio). Uno de los más usados en este texto es el compendio de Kaplan \& Sadock \cite{sadock2015kaplan}.
...
\item Un texto sobre psicofarmacología. Uno de los más populares es el de Stahl \cite{stahl2021stahl}.
\end{itemize}
...
\begin{itemize}
\item Uno de las mejores referencias en psicofarmacología por la abundancia de tablas y accesibilidad de la información es el ``Clinical Handbook of Psychotropic Drugs''\cite{procyshyn2023clinical}.
\end{itemize}
\printbibliography[]
